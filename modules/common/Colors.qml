...
Singleton {
    ...
    readonly property color primary: "#9BCBFA"
    ...
    readonly property color emptyWorkspace: "#77767b"

    readonly property color base: "#000000"

    readonly property color overlay0: "#555555"
    readonly property color overlay1: "#4B4B4B"

    readonly property color powerButton: "#DD5C82"
}
