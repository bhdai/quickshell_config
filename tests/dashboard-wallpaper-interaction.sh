...
for file in DashboardCard.qml DashTabBar.qml CalendarPane.qml CalendarCard.qml WeatherHeader.qml WeatherTiles.qml WeatherTile.qml WallpaperPane.qml WallpaperTile.qml calendar_layout.js dashboard_metrics.js; do
